  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 2000 }}>
      <div style={{ maxWidth: '460px', width: '92vw', margin: '50px auto', padding: '28px', background: 'var(--sidebar-bg)', color: 'var(--text-primary)', borderRadius: 12, boxShadow: '0 8px 24px rgba(0,0,0,0.35)', textAlign: 'center' }}>
        ...
        <p style={{ marginBottom: 16, fontSize: 14, fontWeight: 700, opacity: 0.9 }}>Elige Registrar o Iniciar Sesión. Sin backend por ahora.</p>
        ...
        {activeTab === 'register' ? (
          <>
            ...
            {/* Iniciar con Google (botón blanco con icono, colores oficiales) */}
            <button onClick={loginNotImplemented} style={{ width: '100%', padding: 12, borderRadius: 10, border: '1px solid #dadce0', background: '#fff', color: '#000', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
          ...
          <>
            ...
            <button onClick={loginNotImplemented} style={{ width: '100%', padding: 12, borderRadius: 10, border: '1px solid rgba(255,255,255,0.12)', background: 'var(--accent)', color: '#fff', fontWeight: 800, cursor: 'pointer' }}>Entrar</button>
